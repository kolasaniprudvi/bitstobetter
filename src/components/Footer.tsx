        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <nav aria-label="Footer services navigation">
              ...
              <li><a href="#" className="hover:text-white dark:hover:text-gray-100 transition-colors">Investment Management</a></li>
              <li><a href="#" className="hover:text-white dark:hover:text-gray-100 transition-colors">Wealth Planning</a></li>
              <li><a href="#" className="hover:text-white dark:hover:text-gray-100 transition-colors">Retirement Planning</a></li>
              <li><a href="#" className="hover:text-white dark:hover:text-gray-100 transition-colors">Financial Planning</a></li>
              <li><a href="#" className="hover:text-white dark:hover:text-gray-100 transition-colors">Real Estate Investment</a></li>
              <li><a href="#" className="hover:text-white dark:hover:text-gray-100 transition-colors">Business Solutions</a></li>
              </ul>
            </nav>
          </div>
          ...
          <div>
            ...
            <nav aria-label="Footer company navigation">
              <ul className="space-y-2 text-gray-400 dark:text-gray-300">
              <li><a href="#" className="hover:text-white dark:hover:text-gray-100 transition-colors">About Us</a></li>
              <li><a href="#" className="hover:text-white dark:hover:text-gray-100 transition-colors">Our Team</a></li>
          ...
          <div>
            ...
            <div className="space-y-3 text-gray-400 dark:text-gray-300">
              ...
              <div className="flex items-center space-x-3">
                ...
                <span>info@financecore.com</span>
              </div>
        ...
        <div className="border-t border-gray-800 dark:border-gray-700 mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 dark:text-gray-300 text-sm">
              © 2024 FinanceCore. All rights reserved.
            </p>
