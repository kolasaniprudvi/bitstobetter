  ...
  const services = [
    {
      ...
      description: "AI-powered portfolio management with risk-adjusted returns tailored to your financial goals and risk tolerance.",
    ...
    },
    {
      ...
      link: "/services/real-estate-investment"
    },
    {
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8" role="list">
          {services.map((service, index) => (
            <article key={index} className="bg-white dark:bg-gray-900 rounded-xl p-8 shadow-lg hover:shadow-xl dark:shadow-gray-900/20 transition-all duration-200 group border border-transparent dark:border-gray-700" role="listitem">
              ...
              <Link 
                to={service.link}
                className="text-blue-900 dark:text-blue-400 font-semibold hover:text-blue-700 dark:hover:text-blue-300 transition-colors" 
